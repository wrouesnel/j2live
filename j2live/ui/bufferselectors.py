...
@Gtk.Template(filename=os.path.join(os.path.dirname(j2live.__file__),"resources", "ui", "encoding-selector.ui"),
              #resource_path='/org/gnome/meld/ui/encoding-selector.ui'
)
...
@Gtk.Template(
    filename=os.path.join(os.path.dirname(j2live.__file__),"resources", "ui", "language-selector.ui"),
    #resource_path='/org/gnome/meld/ui/language-selector.ui'
)
